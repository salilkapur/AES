...
module gcm_aes(
    ...
    */
    ...
    module aes_encrypt_stage aes_encrypt_cb_stage1(w_s2_cb, r_s2_key_schedule, 1, w_s2_encrypted_cb);
    module aes_encrypt_stage aes_encrypt_cb_stage2(r_s3_encrypted_cb, r_s3_key_schedule, 3, w_s3_encrypted_cb);
    module aes_encrypt_stage aes_encrypt_cb_stage3(r_s4_encrypted_cb, r_s4_key_schedule, 5, w_s4_encrypted_cb);
    module aes_encrypt_stage aes_encrypt_cb_stage4(r_s5_encrypted_cb, r_s5_key_schedule, 7, w_s5_encrypted_cb);
    module aes_encrypt_stage aes_encrypt_cb_stage5(r_s6_encrypted_cb, r_s6_key_schedule, 9, w_s6_encrypted_cb);

    module aes_encrypt_stage aes_encrypt_h_stage1(128'b0, r_s1_key_schedule, 1, w_s1_h);
    module aes_encrypt_stage aes_encrypt_h_stage2(r_s2_h, r_s2_key_schedule, 3, w_s2_h);
    module aes_encrypt_stage aes_encrypt_h_stage3(r_s3_h, r_s3_key_schedule, 5, w_s3_h);
    module aes_encrypt_stage aes_encrypt_h_stage4(r_s4_h, r_s4_key_schedule, 7, w_s4_h);
    module aes_encrypt_stage aes_encrypt_h_stage5(r_s5_h, r_s5_key_schedule, 9, w_s5_h);

    module aes_encrypt_stage aes_encrypt_j0_stage1(r_s2_j0, r_s2_key_schedule, 1, w_s2_j0);
    module aes_encrypt_stage aes_encrypt_j0_stage2(r_s3_j0, r_s3_key_schedule, 3, w_s3_j0);
    module aes_encrypt_stage aes_encrypt_j0_stage3(r_s4_j0, r_s4_key_schedule, 5, w_s4_j0);
    module aes_encrypt_stage aes_encrypt_j0_stage4(r_s5_j0, r_s5_key_schedule, 7, w_s5_j0);
    module aes_encrypt_stage aes_encrypt_j0_stage5(r_s6_j0, r_s6_key_schedule, 9, w_s6_j0);
